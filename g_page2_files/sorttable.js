...
function ts_makeSortable(table) {
    //Añadimos funcionalidad contemplando que la fila de ordenacion no tiene porque ser la primera, sino la ultima que encontramos dentro del thead
    ...
    for (var i=0;i<firstRow.cells.length;i++) {
        ...
        //Añadimos funcionalidad indicando que solo sera ordenable las celdas con clase sort
...
function ts_resortTable(lnk) {
    ...
    //Añadimos funcionalidad, en vez de leer el dato de la fila 1 de la tabla, la leemos de la primera fila que encontramos en el tBodies
    ...
    //Añadimos funcionalidad, en vez de recoger la fila 0, recogemos la ultima fila del thead
    if (!table.tHead || !table.tHead.rows || 0 == table.tHead.rows.length)
    {
    ...
    //Añadimos funcionalidad, todas las filas a ordenar seran todas las del tBody en vez de todas las filas a partir de la fila 1
    if (!table.tHead || !table.tHead.rows || 0 == table.tHead.rows.length || !table.tBodies[0] || !table.tBodies[0].rows || 0 == table.tBodies[0].rows.length) 
    {
...
//Se añade una nueva funcion para que ordene correctamente en citaciones_plan por fecha y hora
